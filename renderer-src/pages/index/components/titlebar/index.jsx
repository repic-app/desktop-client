...
export default React.memo(({ preferences, appState, setAppState }) => {
  ...
  return (
    <div className="component-title-bar">
      ...
      <a href="javascript:void(0);" data-disabled={appState.showPreferences || appState.showAbout} onClick={toggleDropdownMenu} className="button-toggle-dropdown"><i className="mdi mdi-settings"></i></a>
      <Modal
